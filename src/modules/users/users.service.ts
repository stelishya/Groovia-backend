...
export class UsersService implements IUserService{
    constructor(@Inject(IUserRepositoryToken) private readonly _userRepository: IUserRepository) {}
    ...
    async updatePassword(userId: Types.ObjectId, newPassword: string):Promise<boolean>{
