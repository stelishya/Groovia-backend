...
export class UserAuthController {
    ...
    async signup(@Body() signupDto: SignupDto
        ...
        return await this._userAuthService.signup(
            signupDto
        );
    }
    ...
    async resetPassword(@Body() body: { token: string, password: string }) {
        console.log("resetting password in resetPassword in user-auth.controller.ts", body)
    ...
    async changePassword(
        ...
        return await this._userAuthService.changePassword(req.user.userId, changePasswordDto);
    }
}
